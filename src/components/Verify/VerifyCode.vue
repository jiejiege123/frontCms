 ...
 * @LastEditTime: 2019-12-12 11:08:40
...
<template>
  <div class="cerify-code-panel">
    ...
    >
      <!-- 显示字符串 -->
      <span v-for="(code,index) in codeShow" :key="index" :style="code.style">
        {{ code.char || code }}
      </span>
    </div>
    <div class="verify-code-area" :style="{'width': width}">
      <div class="verify-input-area">
        <input v-model="inputValue" type="text" class="varify-input-code">
      </div>
